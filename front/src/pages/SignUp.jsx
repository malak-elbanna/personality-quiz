          ...
          <form className="max-w-md mx-auto" onSubmit={handleSubmit}>
            ...
            <div className="mb-4">
              ...
              <div className="mt-2 text-left">
                ...
                />
                <label htmlFor="showPassword" className="ml-2 text-purple-700">Show Password</label>
              </div>
            </div>
            <div className="mb-4">
              <label className="block text-left text-purple-700 mb-2" htmlFor="phone">Phone Number</label>
              <input 
                type="tel" 
                id="phone" 
                className="w-full px-3 py-2 border border-purple-300 rounded" 

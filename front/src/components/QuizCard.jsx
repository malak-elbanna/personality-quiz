...
const QuizCard = ({ quiz, buttonText = "Take Quiz", onButtonClick }) => {
  const { id, title, description, estimatedTime, ageRange, image } = quiz;
  ...
  return (
    <div className="quiz-card bg-gradient-to-br from-purple-100 to-purple-200 shadow-lg rounded-xl p-6 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 hover:scale-105">
      ...
      <button 
        className='p-2 bg-indigo-500 text-white rounded-lg shadow hover:bg-indigo-600 mt-5' 

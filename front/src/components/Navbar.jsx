      ...
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="flex-1 flex justify-center">
          <div className={`flex-col md:flex-row md:flex space-y-4 md:space-y-0 md:space-x-6 ${menuActive ? 'flex' : 'hidden'} md:flex`}>
            ...
            <Link to="/personalitytypecompatibility" className="text-purple-600 hover:text-purple-800 hover:underline hover:underline-offset-8">Personality Types Compatibility</Link>
